...
| `icosys`  | `30-icosys-actuator.yaml` | ICOSYS Spring Boot services (icglb 8010, icbpm 8020, icdms 8030, ichrm 8040, icasm 8050, icwfl 8060) — health, uptime, heap, threads, http_requests |
